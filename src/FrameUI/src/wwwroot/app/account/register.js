    ...
    Register.prototype.register = function () {
        ...
        this.membershipService.register(this.newUser)
            ...
            if (registrationResult.Succeeded) {
                _this.notificationService.printSuccessMessage(new Array('Dear ' + _this.newUser.Username + ', please login with your credentials'));
                _this.router.navigate(['/account/login']);
            }
            else {
                _this.notificationService.printErrorMessage([]);
            }
        });
    };
    ;
